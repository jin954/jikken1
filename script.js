document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('reset-defaults-pomodoro').addEventListener('click', resetToDefaults);
    document.getElementById('reset-defaults-countdown').addEventListener('click', resetToDefaults);
});
